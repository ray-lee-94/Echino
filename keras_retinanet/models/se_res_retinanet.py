...
class SE_ResNetBackbone(Backbone):
    ...
    def retinanet(self, *args, **kwargs):
        ...
        """
        return se_resnet_retinanet(*args, backbone=self.backbone, **kwargs)
...
def se_resnet_retinanet(num_classes, backbone='se_resnet50', inputs=None, modifier=None, **kwargs):
